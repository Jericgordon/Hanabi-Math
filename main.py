...
from Cheating_strategies import Cheating_play,Cheating_play_discard,Clue_color, Clue_num
...
def main():
    ...
    for _ in range(iterations):
        ...
        score_clue_num[s.play_game(Clue_color)] += 1 
    ...
    plt.bar(r + width,score_clue_color,color = 'red',width=.25)
    plt.show()
